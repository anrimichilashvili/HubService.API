...
namespace HubService.Application.RabbitMq.Services
{
    public class RabbitMqConsumer : IMessageConsumer, IDisposable
    {
        ...
        {
            _exchangeName = _configuration["ReceiverFromLeaderBoardRabbitMq:ExchangeName"];
            _routingKey = _configuration["ReceiverFromLeaderBoardRabbitMq:RoutingKey"];
            _queueName = _configuration["ReceiverFromLeaderBoardRabbitMq:QueueName"];
